---
title: "Workshop Rmd example-ALR"
...
```{r load_data}
data <- read.csv("data/data/counts.rpkm.csv", header=T, row.names=1) 
meta <- read.csv("data/data/mouse_exp_design.csv", header=T, row.names=1)
